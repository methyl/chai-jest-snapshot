...
__dirname = "/home/lucek/workspace/chai-jest-snapshot/src/spec";
...
describe("matchSnapshot", function () {
  ...
  var createMatchOperation = function createMatchOperation() {
    var assert = _sinon2.default.spy();
    var internal = {};
    var timesRan = 0;
    var matchSnapshot = (0, _buildMatchSnapshot2.default)(utils);
